...
IL_0015:
	{
		...
		String_t* L_3 = ___0_s;
		STORE_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_CoreModule + 19516));
		NullCheck(L_3);
		int32_t L_4;
	...
	}
	{
		...
		STORE_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_CoreModule + 19520));
		uintptr_t L_7;
